...
class _BusSignUpFormState extends State<BusSignUp> {
  ...
  Widget build(BuildContext context) {
    // return Expanded(child: Column(children: [BusForm(), StopsForm()]));
                  ...
                  onPressed: () {
                    setState(() {
                      ...
                      StopForm newStop = StopForm(
                        ...
                        longitudeController: stopsControllers.last["longitude"],
                      );
                  ...
                  onPressed: () {
                    setState(() {
                      if (stopsFormsWidgets.isNotEmpty) {
                        stopsControllers.removeAt(stopsControllers.length - 1);
                        stopsFormsWidgets = List.from(stopsFormsWidgets);
